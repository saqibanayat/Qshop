...
import { deleteFavoriteApi, getFavoriteApi } from "../../Redux/slice/authSlice";
...
{
  listOfFavoriteProducts?.data.map((item,index)=>{
    return(
      <>
       <div className="border border-gray-300 shadow-lg rounded-lg p-2">
          ...
          <div className="flex gap-11">
            <img src={item?.productId?.images[0]} className="w-[100px] mt-3" alt="" />
             <div className="mt-2 ">
          ...
          <div className="flex justify-end items-end mt-2">
            ...
            <button className="border border-[#FF4747] text-[#FF4747] font-bold py-2 px-2 rounded ml-2">
              <Trash2 onClick={()=>deleteFavoriteHandle(item?.productId?._id)} />
            </button>
          </div>
        </div>
      </>
